...
public abstract class VGDLSprite {
    ...
    public boolean groundIntersects (VGDLSprite sp)
    {
        ...
        boolean otherHigher = sp.lastrect.getMinY() > (this.lastrect.getMinY()+(this.rect.height/2.0));
    ...
    public void loadImage()
    {
        ...
        boolean isOrientedImg = (orientedImg != null);
        Direction[] directions = {Types.DUP,Types.DDOWN,Types.DLEFT,Types.DRIGHT};
        if(images == null && orientedImg == null && str == null)
        {
            return;
        }

        if(images.isEmpty() && str != null)
        {
...
//        toSprite.itypes.addAll(this.itypes);
    ...
    public boolean equiv(Object o)
    {
        ...
        if(!(o instanceof VGDLSprite other)) return false;
