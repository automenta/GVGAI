...
public class Test {
    ...
    public static void main(String[] args) {
		...
		String generalTreeSearch = "tracks.singlePlayer.GeneralTreeSearch.Agent";
		...
		System.out.println("play " + gameIdx + ": " + gameName);
		...
		ArcadeMachine.runOneGame(game, level1, visuals,
				//sampleRHEAController
				sampleMCTSController
				//generalTreeSearch
